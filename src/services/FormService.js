...
export default class FormService {
  ...
  async recommendFurniture(participantId, recommendationType, formDTO) {
    ...
    if (isEqual(keyStyle, ["모던", "내추럴"])) {
      message =
        "모노톤 배경에 우드, 식물로 포인트를 준 스타일링을 선호하시는군요. 플랜테리어도 좋은 선택지가 될 수 있습니다. 아래 추천 가구를 확인하시고 당신만의 공간을 꾸며보세요.";
      ...
      message =
        "화이트 배경에 따뜻한 느낌의 오브제를 활용한 연출을 선호하시는군요. 패브릭 소재와 액자, 조명으로 다양한 분위기를 낼 수 있습니다. 아래 추천 가구를 확인하시고 당신만의 공간을 꾸며보세요.";
      ...
      message =
        "짙은 원목 계열 가구를 활용해 레트로한 연출을 선호하시는군요. 클래식한 소품과 레드 컬러를 포인트 색상으로 활용하면 훨씬 세련된 느낌을 줄 수 있습니다. 아래 추천 가구를 확인하시고 당신만의 공간을 꾸며보세요.";
